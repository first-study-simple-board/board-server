...
public class PostDataLoader {
    ...
    public void init() {
        ...
        UserEntity user1 = new UserEntity(null, "1234", "User 1", "A");
        UserEntity user2 = new UserEntity(null, "1234", "User 2", "A");
        UserEntity user3 = new UserEntity(null, "1234", "User 3", "A");
